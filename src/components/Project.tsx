...
const data = [
  ...
  },
  {
    id: 1,
    title: 'Countdown App',
    description: 'Countdown time application build using Next.js, Typescript and Tailwind CSS',
    img: "/Project_2.jpg",
    tags: ['React', 'Next.js', 'Typescript', 'Tailwind CSS'],
  },
  {
...
const Project = () => {
  return (
    <div id='Projects' className='container pt-36'>
      <h1 data-aos="zoom-in" className='flex justify-center text-4xl underline mb-10 text-black'>
        My Projects
      </h1>
      <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-10 place-items-center'>
        {data.map((el) => (
          <Card
            key={el.id}
            title={el.title}
